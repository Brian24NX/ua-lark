...
import static com.iss.ua.lark.common.constant.Constant.*;
...
public class SwaggerConfiguration {
	...
	private static List<Parameter> defaultHeader(){
		ParameterBuilder userCode = new ParameterBuilder();
		userCode.name(USER_CODE).description("用户编号").modelRef(new ModelRef("string")).parameterType("header").required(true).build();
		//签名
